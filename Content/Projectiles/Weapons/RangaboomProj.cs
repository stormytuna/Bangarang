...
public class RangaboomProj : Boomerang
{
    ...
    public override void OnSpawn(IEntitySource source) {
        AI_SpawnPortal = Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<RangaboomPortalProj>(), 0, 0f, Projectile.owner, Projectile.whoAmI);
...
public class RangaboomPortalProj : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        Rectangle sourceRectangle = new(0, startY, Wibble.Width(), frameHeight);
